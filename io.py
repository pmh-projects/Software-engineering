...
#         r2.pause_threshold = 2     
#         audio = r2.listen(source, timeout=2)  

#     try:
                    
#         print("Sprawdzam co powiedziano") 
#         record2 = r2.recognize_google(audio, language='pl-PL') #rozpoznanie mowy za pomocą google speech_recognition
#         print(f"Powiedziano: {record2}\n")
#         if "dobrze" == record2 or "bardzo dobrze" == record2 or "Dobrze" == record2:
#             say("Dobrze słyszeć, że masz się " + record2 + ". Tak trzymać.")

#     except Exception as e:
#         print(e)  
#         say("Nie zrozumiałam co mówisz, ale mam nadzieję, że równie dobrze jak ja.")
#         return(":)")
#     except:
